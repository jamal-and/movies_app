...
void showRequestDetails({
  ...
  const String classNameColor = '\x1B[35m';

  final String requestStatus = isError
      ? '🛑$borderColor ******** Request Error $classNameColor$className $borderColor**********🛑'
      : otherCatch
          ? '📓$borderColor ******** Request Catch Error $classNameColor$className $borderColor**********📓'
          : '📗$borderColor ******** Success Request $classNameColor$className $borderColor**********📗';
